...
## 10. Cómo Reproducir este Análisis

Clona el repositorio, carga `/dataset/Superstores.csv` en SQL Server, y 
ejecuta los scripts de `/scripts` en orden (03 → 04 → 05 → 06). El 
diccionario de datos completo está en `/documentation/diccionario_datos.md`.